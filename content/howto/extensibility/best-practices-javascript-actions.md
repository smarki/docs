...
The Mendix hybrid app ships with a large set of plugins by default. For more details on default plugins, see the [Version Upgrades](/releasenotes/mobile/hybrid-app#upgrades-20) section of *Hybrid App*.
